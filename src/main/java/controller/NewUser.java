...
public class NewUser {
    ...
    public static void AddNewUser(User user) throws SQLException {
        ...
        if (userExists == 0) {
            ...
            doStatementDatabase(conn, insertSql);


            if (user.getType() == 0) {
                String insertSql1 = "INSERT INTO patient (idPatient) VALUES (1) ;";      //ON MET STRING.GET
                doStatementDatabase(conn, insertSql1);
            } else if (user.getType() == 1) {
                String insertSql1 = "INSERT INTO volunteer (idVolunteer) VALUES (2) ;";
                doStatementDatabase(conn, insertSql1);
            } else if (user.getType() == 2) {
                String insertSql1 = "INSERT INTO guarantor (idGuarantor) VALUES (3) ;";
                doStatementDatabase(conn, insertSql1);
            } else {
